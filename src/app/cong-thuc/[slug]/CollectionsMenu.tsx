...
import { IconClipboard, IconPlus, IconX } from "@/app/icons";
import {
  ...
  return (
    <>
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-pink-300 text-pink-600 hover:bg-pink-50 transition-colors"
      >
      ...
      {open && (
        ...
        >
          <div
            ref={panelRef}
            className="w-full max-w-[320px] max-h-[80vh] overflow-y-auto rounded-[24px] bg-surface p-4 shadow-[0_30px_60px_-20px_rgba(0,0,0,0.4)]"
          >
